...
func (s *Server) setupRoutes() {
	...
	repositories := api.Group("/repositories")
	{
		...
		repositories.GET("/:id/files/history", s.repositoryHandler.FileHistory)
		repositories.GET("/:id/files/history/:hash/diff", s.repositoryHandler.FileDiffAtCommit)
		repositories.GET("/:id/search", s.repositoryHandler.SearchRepository)
