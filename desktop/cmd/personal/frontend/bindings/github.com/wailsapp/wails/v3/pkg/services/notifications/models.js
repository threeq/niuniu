...
export class NotificationService {
     ...
     * @param {Partial<NotificationService>} [$$source = {}] - The source object to create the NotificationService.
     */
    constructor($$source = {}) {
    ...
    static createFrom($$source = {}) {
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        return new NotificationService(/** @type {Partial<NotificationService>} */($$parsedSource));
    }
}
