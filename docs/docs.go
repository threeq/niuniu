...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Niuniu",
            "url": "https://github.com/niuniu-dev/niuniu"
        },
        "license": {
            "name": "MIT",
    ...
    "paths": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.UpdateColumnRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.IssueResponse"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.CreateIssueRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.UpdateColumnPositionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.DirectoryListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.MoveIssueRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "default": "active",
                        "description": "Comma-separated statuses (active,hidden)",
                        "name": "status",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.CreateColumnRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/repositories": {
            ...
            "post": {
                "description": "Create a new repository. Provide either ` + "`" + `path` + "`" + ` (local directory) or ` + "`" + `remote_url` + "`" + ` (git remote).\nWhen ` + "`" + `remote_url` + "`" + ` is set, the repository is cloned into ~/git-repos/\u003cname\u003e first,\nthen the cloned path is registered. Supports https://, http://, git://, ssh://,\nftp://, ftps://, file://, and SCP-style git@ URLs.\nWhen ` + "`" + `path` + "`" + ` is provided and ` + "`" + `auto_init` + "`" + ` is true, the directory is created and git-init'd if needed.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "Repository details; provide path OR remote_url",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.CreateRepositoryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/repositories/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.UpdateRepositoryRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Also delete the repository directory from disk",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/service.BranchTree"
                        }
                    },
                    "404": {
                        "description": "Not Found",
        ...
        "/repositories/{id}/branches/checkout": {
            "put": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/git.CommitDetail"
                        }
                    },
                    "404": {
                        "description": "Not Found",
        ...
        "/repositories/{id}/git/status": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Workspace ID (optional, for worktree path)",
                        "name": "workspace_id",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.GitStatusResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/repositories/{id}/graph": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Max commits (default 100, max 500)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "Include all branches (default true)",
                        "name": "all",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/git.GraphCommit"
                            }
                        }
                    },
                    "404": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/service.RepositoryStats"
                        }
                    },
                    "404": {
                        "description": "Not Found",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/git.WorktreeInfo"
                            }
                        }
                    },
                    "404": {
        ...
        "/repositories/{id}/worktrees/{worktree_id}": {
            "delete": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/service.SystemDepsInfo"
                        }
                    }
                }
            }
        },
        "/system-deps/git-identity": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.setGitIdentityReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.installReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.installResp"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/workspaces/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Force delete without change check",
                        "name": "force",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.SendInputRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/api.StartAgentRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.SetEnvRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/workspaces/{id}/repositories/{repo_id}/diff": {
            "get": {
        ...
        "/workspaces/{id}/repositories/{repo_id}/diff/{path}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "File path (supports nested paths)",
                        "name": "path",
                        "in": "path",
                        "required": true
                    }
        ...
        "/workspaces/{id}/repositories/{repo_id}/files": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.FileContentResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
        ...
        "/workspaces/{id}/repositories/{repo_id}/git/branches": {
            "get": {
        ...
        "/workspaces/{id}/repositories/{repo_id}/git/commit": {
            "post": {
        ...
        "/workspaces/{id}/repositories/{repo_id}/git/fetch": {
            "post": {
        ...
        "/workspaces/{id}/repositories/{repo_id}/git/log": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Limit number of commits (default: 10)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
        ...
        "/workspaces/{id}/repositories/{repo_id}/git/pull": {
            "post": {
        ...
        "/workspaces/{id}/repositories/{repo_id}/git/push": {
            "post": {
        ...
        "/workspaces/{id}/repositories/{repo_id}/git/status": {
            "get": {
    ...
    "definitions": {
        ...
        "api.BgTaskAggregateDTO": {
            ...
            "properties": {
                ...
                "highlight": {
                    "$ref": "#/definitions/api.BgTaskHighlight"
                },
                "subagent_count": {
                    "type": "integer"
                },
        ...
        "api.BgTaskHighlight": {
            ...
            "properties": {
                "kind": {
                    "description": "\"bash\" | \"subagent\" | \"wakeup\"",
                    "type": "string"
                },
                "scheduled_for": {
                    "description": "RFC3339, set for wakeup",
                    "type": "string"
                },
                "started_at": {
                    "description": "RFC3339, set for bash/subagent",
                    "type": "string"
                },
                "title": {
                    "type": "string"
        ...
        "api.CreateRepositoryRequest": {
            ...
            "properties": {
                "auto_init": {
                    "description": "Pointer to distinguish between unset and false",
                    "type": "boolean"
                },
                "name": {
                    "type": "string"
        ...
        "api.CreateWorkspaceOwnerRequest": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "api.CreateWorkspaceRequest": {
            ...
            "properties": {
                ...
                "owner": {
                    "$ref": "#/definitions/api.CreateWorkspaceOwnerRequest"
                },
                "repos": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.RepoBranchRequest"
                    }
                }
            }
        },
        "api.CreateWorkspaceResponse": {
            ...
            "properties": {
                "errors": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.CreateWorkspaceErrorEntry"
                    }
                },
                "id": {
                    "type": "string"
                ...
                "repositories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.CreateWorkspaceSuccessRepo"
                    }
                },
                "status": {
                    "type": "string"
        ...
        "api.CreateWorkspaceSuccessRepo": {
            "type": "object",
            "properties": {
                "branch": {
                    "type": "string"
        ...
        "api.DirectoryListResponse": {
            "type": "object",
            "properties": {
                "directories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.DirectoryEntry"
                    }
                },
                "parent": {
                    "type": "string"
        ...
        "api.IssueResponse": {
            ...
            "properties": {
                ...
                "assignees": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.IssueAssigneeResponse"
                    }
                },
                "checklist_stats": {
                    "$ref": "#/definitions/api.ChecklistStatsDTO"
                },
                "column_id": {
                    "type": "integer"
                },
                ...
                "description": {
                    "type": "string",
                    "example": "Add JWT-based user authentication"
                },
                "due_date": {
                    "type": "string"
                },
        ...
        "api.ProjectResponse": {
            ...
            "properties": {
                ...
                "issue_stats": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.ColumnIssueStat"
                    }
                },
                "name": {
                    "type": "string",
                ...
                "owner": {
                    "$ref": "#/definitions/api.OwnerDTO"
                },
                "repositories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.ProjectRepositoryBinding"
                    }
                },
                "status": {
                    "type": "string",
                ...
                "ws_stats": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.WsStatusStat"
                    }
                }
            }
        },
        "api.RepoBranchRequest": {
            "type": "object",
            "required": [
                "branch",
                "repo_id"
        ...
        "api.RepositoryResponse": {
            ...
            "properties": {
                ...
                "git_remote": {
                    "type": "string",
                    "example": "https://github.com/niuniu-dev/niuniu.git"
                },
                "id": {
                    "type": "integer"
                },
        ...
        "api.SystemInfoResponse": {
            ...
            "properties": {
                "disk_drives": {
                    "description": "Windows drive letters, empty on Linux",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "api.UpdateColumnPositionRequest": {
            "type": "object",
            "properties": {
                "position": {
                    "type": "integer"
        ...
        "api.WorkspaceResponse": {
            ...
            "properties": {
                ...
                "bg_tasks": {
                    "$ref": "#/definitions/api.BgTaskAggregateDTO"
                },
                "changes_count": {
                    "type": "integer"
                },
                ...
                "task_stats": {
                    "$ref": "#/definitions/api.TaskStatsDTO"
                },
                "updated_at": {
                    "type": "string",
                    "example": "2026-03-17T12:00:00Z"
                ...
                "worktrees": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.WorktreeSidebarDTO"
                    }
                }
            }
        },
        "api.WorktreeSidebarDTO": {
            "type": "object",
            "properties": {
                "ahead_count": {
                    "type": "integer"
        ...
        "service.SystemDepsInfo": {
            ...
            "properties": {
                ...
                "tools": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.ToolStatus"
                    }
                }
            }
        },
        "service.ToolExtras": {
            ...
            "properties": {
                "git_identity": {
                    "$ref": "#/definitions/service.GitIdentity"
                }
            }
        },
        "service.ToolStatus": {
            ...
            "properties": {
                "extras": {
                    "$ref": "#/definitions/service.ToolExtras"
                },
                "found": {
                    "type": "boolean"
                },
